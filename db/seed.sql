...
INSERT INTO matches (player_1_id, player_2_id, lap_id, discipline)
    VALUES (1, 2, 1, 'hatchet'),
            (1, 3, 2, 'hatchet');
...
INSERT INTO scores (competitor_id, match_id, quick_points, sequence, throw1, throw2, throw3, throw4, throw5, throw6, throw7, throw8, total, win)
    VALUES (1, 3, 2, 'ORANGE D (Bottom Right),BLUE C (Bottom Left),RED A (Top Left),GREEN B (Top Right),RED A (Top Left),GREEN B (Top Right),ORANGE D (Bottom Right),BLUE C (Bottom Left)', 2, 4, 2, 4, 2, 4, 2, 4, 25, TRUE),
    (2, 4, 4, 'ORANGE D (Bottom Right),BLUE C (Bottom Left),RED A (Top Left),GREEN B (Top Right),RED A (Top Left),GREEN B (Top Right),ORANGE D (Bottom Right),BLUE C (Bottom Left)',1, 8, 1, 8, 1, 8, 1, 8, 40, TRUE);